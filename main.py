...
"""
╔══════════════════════════════════════════════════════════╗
║              𝙵𝙱𝙸 𝚂𝚄𝙳𝙰𝙽𝙴𝚂𝙴  —  v5.2 (Railway Ready)      ║
╠══════════════════════════════════════════════════════════╣
...
║  ✅ أزرار تواصل موحّدة (Telegram / Facebook)             ║
╚══════════════════════════════════════════════════════════╝
"""
...
.social-btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;
  ...
  font-size:13px;font-weight:700;font-family:'Segoe UI',Tahoma,sans-serif;
