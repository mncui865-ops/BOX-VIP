...
"""
╔══════════════════════════════════════════════════════════╗
║              𝙵𝙱𝙸 𝚂𝚄𝙳𝙰𝙽𝙴𝚂𝙴  —  v3.4 (Railway Ready)      ║
╠══════════════════════════════════════════════════════════╣
...
def view_profile(username):
    ...
    if is_own:
        ...
        if i_blocked_them:
            actions = f'<div class="blocked-badge" style="margin-bottom:10px">🚫 أنت حظرت هذا المستخدم</div>'
