...
"""
╔══════════════════════════════════════════════════════════╗
║              𝙵𝙱𝙸 𝚂𝚄𝙳𝙰𝙽𝙴𝚂𝙴  —  v3.3 (Railway Ready)      ║
╠══════════════════════════════════════════════════════════╣
...
def unread_chat_count(user_id):
    """🆕 استبعاد الرسائل من المستخدمين المحظورين"""
...
def get_friends(user_id):
    """🆕 استبعاد المحظورين من قائمة الأصدقاء"""
...
def view_profile(username):
    ...
    # 🆕 إصلاح: منع زيادة العداد لنفس المستخدم خلال 24 ساعة
    if not is_own:
        try:
            view_key = f"viewed_{user.id}"
            last_view = session.get(view_key, 0)
            now_ts = time.time()
            if now_ts - last_view > 86400:  # 24 ساعة
...
def discover():
    ...
    # 🆕 استبعاد المحظورين والمحظورين من قائمة الاكتشاف
